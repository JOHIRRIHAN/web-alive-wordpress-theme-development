...
<div id="primary" class="content-area">
    ...
    <section class="our-project  border w-full min-h-screen">
            <div class="my-10">
                ...
                <button id="filterToggle" class="block lg:hidden  font-bold py-2 px-4 bg-gray-800 text-black rounded text-4xl">
                <i class='bx bx-menu'></i>
                </button>

                <!-- Filter Links (hidden by default on small screens) -->
                <div id="filterLinks" class="hidden lg:flex flex-wrap justify-center gap-4 mt-5">
                    <a class="filter-link text-base sm:text-lg lg:text-xl font-medium hover:font-bold" href="#" data-filter="all">All</a>
                    <a class="filter-link text-base sm:text-lg lg:text-xl font-medium hover:font-bold" href="#" data-filter="development">Development</a>
                    <a class="filter-link text-base sm:text-lg lg:text-xl font-medium hover:font-bold" href="#" data-filter="ecommerce">Ecommerce</a>
                    <a class="filter-link text-base sm:text-lg lg:text-xl font-medium hover:font-bold" href="#" data-filter="web-design">Web Design</a>
                    <a class="filter-link text-base sm:text-lg lg:text-xl font-medium hover:font-bold" href="#" data-filter="web-development">Web Development</a>
                </div>
            </div>
            <?php
                $args = array(
                ...
                if ($projects_query->have_posts()) :
                    ?>
                    <div class="md:px-10 w-full min-h-screen">
                        <?php
                        while ($projects_query->have_posts()) : $projects_query->the_post();
                            ...
                            ?>
                            <div class="bg-white rounded-lg w-full my-10 h-full gap-10 flex flex-col lg:flex-row <?php echo $is_even ? '' : 'lg:flex-row-reverse'; ?>">
                    <!-- Image Section -->
                    ...
                    <div class="p-5 w-full lg:w-1/2">
                        ...
                        <p class="text-gray-700 mt-4 md:w-96"><?php echo esc_html($project_description); ?></p>
                        <hr class="border-black my-5">
                        <div class="flex flex-col gap-4 my-10 md:flex-row">
                            <div>
