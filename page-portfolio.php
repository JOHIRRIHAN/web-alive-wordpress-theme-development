...
<div id="primary" class="content-area">
    ...
    <!-- Our Project -->
    <section class="bg-red-500  border w-full min-h-screen">
            ...
            if ($projects_query->have_posts()) :
                ...
                <div class="px-20  w-full min-h-screen">
                    ...
                    while ($projects_query->have_posts()) : $projects_query->the_post();
                        ...
                        ?>
                        <div class="bg-white shadow-lg rounded-lg w-full my-10 h-full gap-10 flex ">
                        <div class="group relative overflow-hidden">
                            ...
                            <div class="p-6 w-1/2">
                                ...
                                <hr class="border-black my-5">
                                <a href="<?php the_permalink(); ?>" class="block text-lg font-bold  text-black border-b-2 border-black py-2 px-4 mt-6 rounded "><?php echo esc_html($project_button_text); ?></a>
                            </div>
